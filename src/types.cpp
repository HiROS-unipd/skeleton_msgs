...
namespace hiros {
    namespace skeletons {
        namespace types {
            ...
            // Keypoint
            Keypoint::Keypoint(const unsigned& t_id,
            ...
            {
                t_os << "KeypointGroup_id: " << t_kg.id
                     << " KeypointGroup_confidence: " << t_kg.confidence;
            ...
            // Skeleton
            Skeleton::Skeleton(const unsigned& t_id,
                               const std::vector<KeypointGroup>& t_skeletonParts)
                : id(t_id)
